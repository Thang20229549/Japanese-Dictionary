        ...
        if (null != b && "" != b && null != c && "" != c) {
            ...
            if (o.length > 0)
                for (var h = 0; h < o.length; h++)
                    if (o[h].category == b && o[h].query == c && o[h].type == e && o[h].mean == a.meanMyNote) {
                        f = h;
                        break
                    }
...
maziiServ.factory("historyServ", ["$rootScope", "$q", "$http", "$timeout", "$stateParams", "$state", function(a, b, c, d, e, f) {
    ...
    return i.get = function() {
        ...
        if (null != a && "" != a) {
            null == j && g();
            for (var c = -1, d = 0; d < j.length; d++)
                if (j[d].query == a && j[d].type == b) {
                    c = d;
                    break
                } - 1 != c && j.splice(c, 1);
            var e = 0;
...
maziiServ.factory("maziiServ", ["$rootScope", "$q", "$http", "$timeout", "$stateParams", "$state", function(a, b, c, d, e, f) {
    var g = baseUrl + "api/search/",
        h = baseUrl + "api/refer/",
        i = baseUrl + "api/smile/",
        j = baseUrl + "api/mazii/",
        k = baseUrl + "api/grammar/",
        l = baseUrl + "api/news/",
        m = baseUrl + "api/news/",
        n = baseUrl + "api/gsearch/",
        o = baseUrl + "api/jlptgrammar/",
        p = baseUrl + "api/jlptkanji/",
        q = "http://alt.mazii.net/ene/log",
        r = {},
        s = {};
    ...
    return s.sendAltLog = function(a) {
        ...
        var b = {
            ...
            c = "http://alt.mazii.net/ene/news_log";
        t("POST", c, b)
        ...
        t("POST", g, h)
    }, s.searchJa = function(a) {
        var d = "http://mazii.net/api/search_ja/" + a,
            e = b.defer();
        return null != r[d] ? (e.resolve(r[d]), e.promise) : (c.get(d).success(function(a, b, c, f) {
            a.status == SERVER_ERROR_CODE ? e.resolve(null) : (r[d] = a, e.resolve(a))
        }).error(function(a, b, c, d) {
            e.reject(null)
        }), e.promise)
    }, s
...
dictUtilServices.factory("dictUtilSer", ["$q", "$http", "$timeout", "$state", "localstoreServ", "$rootScope", function(a, b, c, d, e, f) {
    ...
    var k = {},
        ...
        p = "db/kanjimini.json",
        q = "db/javifastdict.txt",
        r = "db/vijafastdict.txt",
        s = null,
        t = null,
        u = null,
    ...
    null == v && (v = !0), k.isVietnamese = function(a) {
        for (var b = a.length, c = 0; b > c; c++)
            if (-1 != l.indexOf(a[c])) return !0;
        return !1
    }, k.capitaliseFirstLetter = function(a) {
        return a.charAt(0).toUpperCase() + a.slice(1)
    }, k.isJapanese = function(a) {
        for (var b = a.length, c = 0; b > c; c++)
            if (k.isKanji(a.charAt(c)) || k.isHiragana(a.charAt(c)) || k.isKatakan(a.charAt(c))) return !0;
        return !1
        ...
        for (var b = a.length, c = 0; b > c; c++)
            if (0 == isHiragana(a.charAt(c))) return !1;
        return !0
        ...
        var c = new RegExp(" ", "g"); - 1 != a.indexOf(" ") && (a = a.replace(c, "")), -1 != b.indexOf(" ") && (b = b.replace(c, "")), c = new RegExp("　", "g"), -1 != a.indexOf("　") && (a = a.replace(c, "")), -1 != b.indexOf("　") && (b = b.replace(c, ""));
        for (var d = [], e = "", f = "", g = "", h = 0, i = 0; i < a.length; i++) {
            ...
            if (k.isKanji(j) || k.isKatakan(j)) {
                ...
                for (g = j; h < b.length;) {
                    if (k.getLengthHiragana(f) < e.length || b.charAt(h) != g) f += b.charAt(h);
                    else if (b.charAt(h) == g) {
                        var l = new Object;
    ...
    return k.getConjugationTableOfVerb = function(a, b, c) {
        ...
        for (var c = new Array, d = 0, e = 0; e < a.length; e++)
        ...
        var c = b.length,
            d = [],
            e = a * PAGINATION_REPORT_MEAN,
            f = e + PAGINATION_REPORT_MEAN,
            g = !1,
            h = !1;
        ...
        for (var b = n.length, c = 0; b > c; c++)
            if (n[c].text == a) return n[c].number;
        return ""
        ...
        if (null == a || "" == a) return ""; - 1 != a.indexOf("「") && (a = a.replace(new RegExp("「", "g"), ""), a = a.replace(new RegExp("」", "g"), "")), a = a.trim();
...
userSerive.factory("userServ", ["$http", "$q", "cookieServ", "$rootScope", "localstoreServ", "dictUtilSer", "encryptionServ", function(a, b, c, d, e, f, g) {
    ...
    h.init = function() {
        var d = b.defer(),
            e = c.getCookie("tokenId");
        e = g.decode(e);
        var h = new Date,
            i = (h.getTimezoneOffset(), h.getTime() - 6e4 * h.getTimezoneOffset());
        i = i.toString();
        var j = f.randomString(50),
            k = f.encodeToken(e + i, j);
        if (null == e || "" == e) d.resolve(null);
        else {
            var l = baseUrlApi + "api/init-login",
                m = {
                    tokenId: k
                };
        ...
        var g = d.user.email,
            h = baseUrlApi + "api/change-password",
            i = {
                passwordOld: c,
                passwordNew: e,
                email: g
        ...
        var d = b.defer(),
            e = baseUrlApi + "api/reset-password",
            f = {
                email: c
            };
        ...
        var e = b.defer(),
            f = baseUrlApi + "api/reset-password-really",
            g = {
                email: c,
                password: d
            };
        ...
        var e = b.defer(),
            f = baseUrlApi + "api/change-username",
            g = {
                email: c,
                username: d
            };
        ...
        if (null == b || 0 == b.length) b = [], b.push(a);
        else {
            var c = b.length,
                d = !1;
            "like" == a.type ? a.type = 1 : a.type = 0;
            for (var f = 0; c > f; f++)
                if (b[f].reportId == a.reportId) {
                    b[f] = a, d = !0;
                    break
                }
            d || b.push(a)
        ...
        var b = a.length,
            c = e.getItem("rateMean");
        null == c && (c = []);
        for (var d = c.length, f = [], g = 0; b > g; g++)
            for (var h = 0; d > h; h++) c[h].reportId == a[g].reportId && f.push({
        ...
        var e = b.defer(),
            f = baseUrlApi + "api/delete-category",
            g = {
                userId: c,
                categoryId: d
            };
        ...
        var f = b.defer(),
            g = baseUrlApi + "api/remember-flash",
            h = {
                userId: c,
                wordId: d,
                type: e
        ...
        var e = b.defer(),
            f = baseUrlApi + "api/get-flashcard",
            g = {
                userId: c,
                type: d
            };
    ...
    }, h.addWord = function(c) {
        var d = b.defer(),
            e = baseUrlApi + "api/add-word",
            f = c;
        return a.post(e, f).success(function(a) {
            d.resolve(a)
        }), d.promise
...
angular.module("mazii", ["ui.router", "mdo-angular-cryptography", "mazii.service.history", "mazii.service.note", "mazii.service.util", "mazii.service.search", "mazii.service.auth", "mazii.service.user", "mazii.service.cookie", "mazii.service.encryption", "mazii.service.spam", "mazii.service.category", "ngAudio", "ngSanitize", "templates-main"]).config(["$stateProvider", "$urlRouterProvider", "$sceProvider", function(a, b, c) {
        b.otherwise("search"), b.when("/search?type&query", ["$match", "$stateParams", function(a, b) {
            ...
            views: {
                ...
                right: {
                    templateUrl: "views/register/right.html"
                }
            }
            ...
            views: {
                ...
                right: {
                    templateUrl: "views/profile/right.html"
                }
            }
        ...
        var o = j.getItem("showFurigana"),
            p = j.getItem("showSuggest");
                    ...
                    if (e.isJapanese(b) ? (f = "ja", g = "vi") : (f = "vi", g = "ja"), 200 == c.status) {
                        if (null != c.data)
                            for (var h = 0; h < c.data.length; h++)
                                if (c.data[h].word == b || c.data[h].phonetic == b) {
                                    c.found = !0;
                                    break
                                }
                        if (0 == c.found) a.suggest = c.data;
                        else {
                            a.words = [], a.suggest = [];
        ...
        }, a.addWord = {}, a.addWord.show = function() {
            a.newword = {}, $("#add-word").modal()
        }, a.addWord.send = function(b) {
            return null == b || null == b.word || "" == b.word || null == b.mean || "" == b.mean ? void a.showAlert("Hãy nhập vào từ và nghĩa") : null == a.user ? void a.showAlert("Bạn cần đăng nhập để sử dụng tính năng này.") : (b.userId = a.user.userId, b.username = a.user.username, void l.addWord(b).then(function(b) {
                console.log(b), a.showAlert("Cảm ơn bạn đã góp ý, chúng tôi sẽ cập nhật mục từ này sớm"), a.newword = {}
            }, function(b) {
                console.log(b), a.showAlert("Từ chưa được gửi đi, vui lòng thử lại.")
            }))
        }, a.report = {}, a.alert = {}, a.report.send = function(b) {
            if (null == b || "" == b) a.report.noComment = !0;
            else {
                (null == a.report.id || null == a.report.type) && ($("#reportModal").modal("hide"), a.showAlert("Báo lỗi không thành công, bạn hãy thử lại."));
                var c = Parse.Object.extend("ReportWrong"),
                    d = new c;
                d.save({
                    entryId: a.report.id,
                    type: a.report.type,
        ...
        return {
            ...
            controller: ["$rootScope", "$scope", "$http", "dictUtilSer", "$timeout", function(a, b, c, d, e) {
                ...
                b.getDetails = function() {
                    ...
                    b.title = "";
                    for (var a = b.data.detail.split("##"), c = 0; c < a.length; c++)
        ...
        return {
            ...
            controller: ["$rootScope", "$scope", "$http", "historyServ", "$state", "localstoreServ", "dictUtilSer", function(a, b, c, d, e, f, g) {
                b.history = d.get(), b.search = function(b, c) {
                    g.closePanel(), a.$broadcast("query", {
                        type: b,
                        query: c,
                        tag: "quick-search"
                    })
            ...
            controller: ["$rootScope", "$scope", "$http", "noteServ", "$state", "dictUtilSer", function(a, b, c, d, e, f) {
                b.note = [], b.state = !1, b.search = function(b, c) {
                    ...
                    d.removeNote(a).then(function() {
                        for (var c = -1, d = 0; d < b.note.length; d++)
                            if (b.note[d].id == a) {
                                c = d;
                                break
        ...
        return {
            ...
            controller: ["$rootScope", "$scope", "$state", "$timeout", "maziiServ", "dictUtilSer", "historyServ", "$stateParams", "$location", function(a, b, c, d, e, f, g, h, i) {
                b.clickID = -1, e.getHeadNews().then(function(a) {
                    ...
                    return b.clickID == c ? !1 : (b.clickID = c, $(".news-link>a").removeClass("news_active"), $(".news-link>#" + c).addClass("news_active"), a.$broadcast("changeDetailNews", {
                        id: c
                    }), -1 == j.indexOf(c) && (j.push(c), localStorage.setItem("news_read", JSON.stringify(j))), void i.search("id", c))
            ...
            controller: ["$rootScope", "$scope", "$http", function(a, b, c) {
                b.showReportDialog = function() {
                    var c = b.type,
                        d = "",
                        e = "";
                    "grammar" == c ? (d = b.data._id, e = b.data.title) : "kanji" == c ? (d = b.data._id, e = b.data.kanji) : "word" == c ? (d = b.data._id, e = b.data.word) : "grammarDetail" == c && (c = "grammar", d = b.data._id, e = b.data.title), a.report.type = c, a.report.entry = e, a.report.id = d, a.report.comment = "", $("#reportModal").modal({
                        backdrop: "static"
                    })
                }
            }]
            ...
            controller: ["$rootScope", "$scope", "dictUtilSer", function(a, b, c) {
                if (b.listAffilate = [], null != a.affilate) {
                    ...
                    if (b.clickToAds = function(a) {
                        ...
                        }), 0 != b.listAffilate.length)
                        for (var d = 0; d < b.listAffilate.length; d++) c.shuffleArray(b.listAffilate[d].link)
                }
            }]
        }
        ...
        return {
            ...
            controller: ["$rootScope", "$scope", "$http", "dictUtilSer", "ngAudio", "userServ", "$timeout", "filterSpamSer", function(a, b, c, d, e, f, g, h) {
                ...
                b.reportMean = function(c, e) {
                    ...
                    if (b.showAlert = !1, h.filterSpamReport(g)) b.showAlert = !0, b.messageAlert = "Góp ý này chứa các ký tự spam", b.faIcon = "fa-exclamation-triangle";
                    else if ($("#add-mean-" + c).addClass("button-disabled"), null == g || "" == g) $("#add-mean-" + c).removeClass("button-disabled"), b.noReportModel = !0;
                    else {
                        b.noReportModel = !1;
                        var j = a.user.userId;
                    ...
                    if (b.showAlert = !1, h.filterSpamReport(g)) b.showAlert = !0, b.messageAlert = "Góp ý này chứa các ký tự spam", b.faIcon = "fa-exclamation-triangle";
                        ...
                        if (null == g || "" == g) b.noReportModel = !0, $("#update-mean-" + c).removeClass("button-disabled");
                        else {
                            b.noReportModel = !1;
                            var i = a.user.userId;
                            f.updateMeanUser(i, g, c, e).then(function(a) {
                                if (304 == a.status) b.messageAlert = "Góp ý này không tồn tại", b.faIcon = "fa-exclamation-triangle";
                                else if (302 == a.status) b.messageAlert = "Xin lỗi, đã xảy ra sự cố", b.faIcon = "fa-exclamation-triangle";
                                else if (b.messageAlert = "Chỉnh sửa góp ý thành công", b.faIcon = "fa-check", null != b.listReport)
                                    for (var e = b.listReport.length, f = 0; e > f; f++)
                                        if (b.listReport[f].wordId == c && b.listReport[f].userId == i) {
                    ...
                    f.rateMean(c, e, d).then(function(a) {
                        if ($("#user-like").removeClass("button-disabled"), 200 == a.status) {
                            ...
                            f.changeDataRateinLocal({
                                reportId: a.result.reportId,
                                type: d
                            })
                        }
                    })
                    ...
                    if ($("#formReport-" + a).css("display", "block"), !b.showColapse) {
                        ...
                        f.getMeanById(a).then(function(c) {
                            if (b.showReport(a, c.result), g(function() {
                                ...
                                }, 2), $("#show-report-" + a).removeClass("button-disabled"), 304 == c.status || 0 == c.result.length) b.noReport = !0, b.numberReport = 0;
                            else if (b.noReport = !1, b.numberReport = c.result.length, c.result = b.renderNewLineReport(c.result), c.result.length <= PAGINATION_REPORT_MEAN) b.listReport = c.result, l();
                            else {
            ...
            controller: ["$rootScope", "$scope", "$http", "dictUtilSer", "maziiServ", "userServ", "$timeout", function(a, b, c, d, e, f, g) {
                ...
                var n = [],
                    ...
                    p = function() {
                        if (i = 1, l = 0, m = 0, "kanji" == a.typeJLPT) {
                            if (b.title = "hán tự", h = [], b.listFlashcard = [], null != a.listJLPT)
                                for (var c = a.listJLPT, d = c.length, g = 0; d > g; g++) {
                                    var j = c[g],
                                        k = {
                                            id: j.id,
                                            front: j.value.kanji,
                        ...
                        f.getListRemember(t, u).then(function(a) {
                            if (200 == a.status) {
                                ...
                                for (var c = n.length, d = 0; c > d; d++)
                                    for (var e = n[d], f = h.length, g = 0; f > g; g++) {
                                        var i = h[g];
                                        if (e.wordId == i.id) {
                                            h[g].status = 1;
                                            break
                ...
                b.flip = function(a) {
                    ...
                    if ("kanji" == a.typeJLPT && "all" == b.typeShow) {
                        ...
                        var f = {
                            id: h[m].id,
                            front: h[m].value.title,
                            after: h[m].value.title
                        };
                        b.listFlashcard.push(f)
                    }
                }, b.prev = function() {
                    ...
                    if (b.loadRemember = !1, "all" == c) {
                        ...
                        for (var d = h.length, f = 0; d > f; f++)
                            if ("word" == a.typeJLPT) {
                                var g = {
                                    id: h[f].id,
                                    front: h[f].word,
                                    after: {
                                        phonetic: h[f].phonetic,
                                        mean: h[f].mean
                                    }
                                };
                            ...
                            var g = {
                                id: h[f].id,
                                front: h[f].value.title,
                                after: h[f].value.title
                            };
                            b.listFlashcard.push(g)
                        } else n.push(h[f]);
                        if ("kanji" == a.typeJLPT)
                        ...
                        for (var d = h.length, f = 0; d > f; f++)
                            if (null != h[f].status && 1 == h[f].status)
                                if ("word" == a.typeJLPT) {
                                    var g = {
                                        id: h[f].id,
                                        front: h[f].word,
        ...
        return {
            ...
            controller: ["$rootScope", "$scope", "$http", "dictUtilSer", "maziiServ", "userServ", "$timeout", "categoryServ", function(a, b, c, d, e, f, g, h) {
                ...
                b.feedback = function(c) {
                    if ($(".thankForFeedback").hide(), c)
                        if (i.length > 0) {
                            var d = k(i[i.length - 1].example);
                            e.sendFeedback(i[i.length - 1].entity_id, i[i.length - 1].category_id, null, 1, d, function(a) {}), i.splice(i.length - 1, 1), localStorage.setItem("dataNew", JSON.stringify(i)), b.showFeedback = !1, b.thankForFeedback = !0, b.showHome = !1, setTimeout(function() {
                                $(".thankForFeedback").fadeOut()
                            }, 1e3), g(function() {
                                b.thankForFeedback = !1, b.showHome = !0
                            }, 1e3), a.$broadcast("reloadData"), j()
                        } else a.$broadcast("removeData"), localStorage.removeItem("dataNew");
                    else b.showCategory = !1, b.Indata.feed = null, b.notShow = !0, b.showHome = !1, b.showFeedback = !0, h.getAllCategory(function(a) {
                    ...
                    if ("send" == c) {
                        if (i.length > 0 && b.showCategory) {
                            ...
                            e.sendFeedback(i[i.length - 1].entity_id, i[i.length - 1].category_id, b.Indata.id, 0, d, function(a) {}), i.splice(i.length - 1, 1), localStorage.setItem("dataNew", JSON.stringify(i)), l(i), b.showFeedback = !1, b.thankForFeedback = !0, setTimeout(function() {
                            ...
                            var d = k(b.exampleCategory);
                            e.sendFeedback(i[i.length - 1].entity_id, i[i.length - 1].category_id, -1, 0, d, function(a) {}), i.splice(i.length - 1, 1), localStorage.setItem("dataNew", JSON.stringify(i)), l(i), b.showFeedback = !1, b.thankForFeedback = !0, setTimeout(function() {
                                b.thankForFeedback = !1, $(".thankForFeedback").fadeOut()
                            }, 1e3), g(function() {
                                b.showHome = !0
                            }, 1e3), a.$broadcast("reloadData")
                ...
                var l = function(a) {
                    ...
                    m = function(a) {
                        var c = a,
                            ...
                            g = c.slice(0, e),
                            h = c.slice(e, e + f),
                            i = c.slice(e + f, c.length),
                            j = g + '<span class="bg-color">' + h + "</span>" + i;
                        b.exampleCategory = j
                    };
                j()
            }]
        ...
        return {
            ...
            controller: ["$rootScope", "$scope", "maziiServ", "categoryServ", function(a, b, c, d) {
                ...
                var i = function() {
                    ...
                    for (var a = !1, c = 0; c < h.length; c++)
                        if (b.aux.entity == h[c].text) {
                            a = !0;
                            break
                        }
                    a || (b.modalfeedback = !1)
                    ...
                    switch (a) {
                        case "send":
                            ...
                            if (b.showCategory) {
                                ...
                                for (var f = "", i = 0; i < h.length; i++)
                                    if (h[i].entity_id == c.id) {
        ...
        return {
            ...
            controller: ["$rootScope", "$scope", "$http", "dictUtilSer", "ngAudio", "userServ", "$timeout", "categoryServ", "maziiServ", function(a, b, c, d, e, f, g, h, i) {
                b.dt = [];
                var j = null;
                b.dataWordJa = [], b.data && i.searchJa(b.data.toString()).then(function(a) {
                    if (a && a.found && 1 == a.found)
                        for (var c = 0; c < a.data.length; c++) {
                            if ((a.data[c].word == b.data || a.data[c].phonetic == b.data) && a.data[c].means && (j = a.data[c].means)) {
                                j = j.toString();
                                var d = j.split("\n");
                                a.data[c].means = d, b.dataWordJa.push(a.data[c])
                            }
                            j = null
                        }
                }), b.setQueryType = function(b, c, d) {
                    null == a.user ? (a.alert.notify = "Đăng nhập để sử dụng tính năng",
                        $(".notify-current").fadeIn(200), g(function() {
                            $(".notify-current").fadeOut(200)
                        }, 1e3)) : ($("#myNote").modal("show"), d.means.length > 0 ? a.meanMyNote = d.means.toString() : a.meanMyNote = "", a.$broadcast("setQueryType", {
                        query: b,
                        type: c
                    }))
                }
        ...
        initSearchCtrl = !0;
        var n = !1;
        b.examples = null, b.words = null, b.kanjis = null, b.grammars = null, b.suggest = null, b.googleTranslate = null, a.title = "Tìm kiếm", b.noResultsKanjis = !0, b.tabSelected = 0, b.showLoading = !1, b.currentKanjiSelected = 0, b.noResults = !1, b.showNotifynewVersion = SHOW_NOTIFY_NEW_VERSION, b.startSearch = !1, b.showReportBox = [], b.dt = [];
        var o, p = !1,
            q = "",
        ...
        b.showKanjiDrawTable = function() {
            ...
            if (null != c && "quick-search" != c.tag)
                if (null == c.query) q = c, b.startQuery(c, !0);
                else {
            ...
            if (r) {
                var b = a.query,
                    c = null;
                if (f.isJapanese(b)) c = f.realtimeSearch("ja", b);
                else if (f.isVietnamese(b)) c = f.realtimeSearch("vi", b);
                else {
        ...
        b.enterInput = function(c) {
            ...
            b.startSearch = !0, null != s && clearTimeout(s), p = !1, b.showServerContent = !1, q = c, b.noResults = !1, b.examples = null, b.words = null, b.kanjis = null, b.grammars = null, b.suggest = null, b.googleTranslate = null, b.lang = "JA", b.showLoading = !0, b.dataWordJa = [], 1 == b.tabSelected && (d = !0);
            var h = !1;
                    ...
                    if (200 == d.status) {
                        if (null != d.data)
                            for (var i = 0; i < d.data.length; i++)
                                if (d.data[i].word == c || d.data[i].phonetic == c) {
                                    d.found = !0;
                                    break
                                }
                        if (0 == d.found) b.suggest = d.data;
                        else {
                            b.words = [], b.suggest = [];
        ...
        b.setTabByChar(t), null != t && "" != t ? (q = t, b.startQuery(t)) : q = "", b.$on("searchKanji", function(a, c) {
            ...
            var c = "http://data.mazii.net/audios/",
                d = c + f.convertJptoHex(a).toUpperCase() + ".mp3";
        ...
        var n = function(b) {
            ...
            for (var e, f, g = {}, h = 0; h < b.def.length; h++)
                for (var i = 0; i < d.length; i++)
                    if (-1 != d[i].indexOf(b.def[h].entity)) {
        ...
        b.playVideo = function() {
            ...
            for (var c = b.currentNews.link, d = 0, e = c.length - 1; e >= 0; e--)
                if ("/" == c[e]) {
                    d = e;
                    break
                }
            ...
            null != l && (c = l), e.getDetailNews(c).then(function(a) {
                ...
                if (d)
                    for (var f = 0; f < d.length; f++) d[f].id == a._id && (d.push({
                        id: a._id
                    }), localStorage.setItem("dtTmp", a._id), n(a));
                else localStorage.setItem("dtTmp", a._id), n(a)
            })
        });
        var o = JSON.parse(localStorage.getItem("news_read"));
        null == o && (o = []), $(document).on("click", "a.dicWin", function(c) {
            var d = c.currentTarget.innerHTML,
                f = "";
            if (f = d.replace(/<rt>.*?<\/rt>/g, ""), f = f.replace(/<.*?>/g, ""), "" != f) {
                ...
                if (null != g && "" != g) {
                    ...
                    var h = null,
                        i = b.currentNews.def;
                    if (null != i)
                        for (var j = 0; j < i.length; j++) i[j].id == g && (h = i[j]);
                    null != h && h.entity != f && (f = h.entity), a.$broadcast("query", {
                        type: "word",
                        query: f,
                        aux: h
                    })
                } else a.$broadcast("query", {
                    type: "word",
                    query: f
                })
            }
        ...
        if (b.getNoteItem = function(b) {
                $(".note-item").removeClass("seleted-note"), $(".note-item-" + b).addClass("seleted-note"), a.$broadcast("getNoteItem", {
                    cate: b
                })
        ...
        var i = io.connect(SERVER_ADRESS),
            j = [],
            k = 0,
            l = 0,
            m = 0,
        ...
        i.on("reset-socket-success", function(c) {
            ...
            for (var e = 0; d > e; e++) {
                var c = a[e].index;
                if (g.renderHtmlMessage(a[e]).length > 1) var f = g.renderHtmlMessage(a[e]),
                    h = {
                        _id: a[e]._id,
            ...
            g.safeApply(b), 0 != c && $("#list-message-" + c).scroll(function() {
                ...
                a > 0 && 20 > a && (++k, i.emit("load-more-message-jlpt", {
                    index: c,
                    indexMessage: k
                }))
            }), o()
        ...
        var r = function(a) {
            var c = $("#enter-chat-message-" + a).val(),
                c = c.trim();
            if (null != c && "" != c)
                if (null == h || "" == h) b.loginFacebook();
                else {
                    var d = {
                        user: b.user,
                        message: c,
        ...
        i.on("receive-list-message-private-in-public", function(a) {
            ...
            if (0 == c) b.listmessageReceive.push(a), j.push(a.your_id);
            else
                for (var d = 0; c > d; d++)
                    if (-1 == j.indexOf(a.your_id)) j.push(a.your_id), b.listmessageReceive.push(a), b.newMessage = !0;
                    else {
        ...
        i.on("get-more-message", function(a) {
            if (null != a && 0 != a.length) {
                ...
                for (var c = a.length, d = 0; c > d; d++) {
                    a[d];
                    if (g.renderHtmlMessage(a[d]).length > 1) var e = g.renderHtmlMessage(a[d]),
                        f = {
                            _id: a[d]._id,
            ...
            g.renderHtmlMessagePrivate(a).length > 1 ? (a.newLine = !0, a.message = g.renderHtmlMessagePrivate(a)) : a.newLine = !1, b.listMessagePrivate.push(a), $(".list-message-private").animate({
                scrollTop: 1e4
            }, 500);
            ...
            a.reverse(), b.listMessagePrivate = a, g.safeApply(b), $(".list-message-private").animate({
                scrollTop: 1e4
        ...
        $("#petition-login").modal("hide"), b.notify = "", b.isLogin = !1, b.login = function(e, g) {
            $(".btn-login").addClass("button-disabled"), d.login(e, g).then(function(e) {
                if ($(".btn-login").removeClass("button-disabled"), 302 == e.status) b.isLogin = !0, b.notify = "Tài khoản chưa được kích hoạt";
                else if (304 == e.status) b.isLogin = !0, b.notify = "Tài khoản hoặc mật khẩu không đúng";
                else {

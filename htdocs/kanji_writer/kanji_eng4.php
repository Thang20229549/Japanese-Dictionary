...
$kanji_array = mb_str_split($kanji);
$kanji_item_html = '<div class="kanji_items" style="position: absolute;bottom: 10px;left: 0px;"><ul style="padding: 0; margin: 0">';
foreach($kanji_array as $kanji_item) {
	$kanji_item_html .= '<li class="kanji_item" onclick=resetWordAndDraw("'.$kanji_item.'")>'.$kanji_item.'</li>';
}
$kanji_item_html .= "</ul></div>";
